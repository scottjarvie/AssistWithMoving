...
export const floorplanSymbolKey: FloorplanSymbolKeyItem[] = [
  ...
  },
  {
    ...
    description: "Sink, toilet, tub/shower, washer/dryer, stove, fireplace, and water heater marks.",
    kind: "fixture",
  },
];
...
export const floorplanRoomLedger: FloorplanRoomLedgerRow[] = [
  {
    ...
    measurement: "2013 sq ft listed conditioned area; patio, carport, workshop, shed excluded",
    confidence: "high",
  },
  {
    id: "lot-target",
  ...
  },
  {
    ...
    measurement: "Carport, rear patio/pool deck, workshop, and shed are visible but excluded",
    confidence: "medium",
  },
  {
    id: "bedroom-wing",
