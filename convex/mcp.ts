...
export const tools: McpToolRegistration[] = [
  defineMcpQuery({
    ...
    fn: internal.mcpTools.getAgentContext,
  ...
  defineMcpQuery({
    ...
    fn: internal.mcpTools.listMovesForHousehold,
  ...
  defineMcpQuery({
    ...
    fn: internal.mcpTools.getMoveSummary,
    args: {
  ...
  defineMcpQuery({
    ...
    fn: internal.mcpTools.listMoveSpaces,
    args: {
      caller: mcpCallerValidator,
      householdId: v.id("households"),
      moveId: v.id("moves"),
  ...
  defineMcpQuery({
    ...
    fn: internal.mcpTools.listItems,
    args: {
      caller: mcpCallerValidator,
      householdId: v.id("households"),
      moveId: v.id("moves"),
  ...
  defineMcpQuery({
    ...
    fn: internal.mcpTools.listBoxes,
    args: {
      caller: mcpCallerValidator,
      householdId: v.id("households"),
      moveId: v.id("moves"),
  ...
  defineMcpQuery({
    ...
    fn: internal.mcpToolsWrite.getMoveOverview,
  ...
  defineMcpQuery({
    ...
    fn: internal.mcpToolsWrite.searchInventory,
  ...
  defineMcpQuery({
    ...
    fn: internal.mcpToolsWrite.getItem,
    args: getItemArgs,
    identityArg: "caller",
  }),
  defineMcpMutation({
    ...
    fn: internal.mcpToolsWrite.upsertItems,
  ...
  defineMcpMutation({
    ...
    fn: internal.mcpToolsWrite.upsertSpaces,
  ...
  defineMcpMutation({
    ...
    fn: internal.mcpToolsWrite.captureToQueue,
  ...
  defineMcpQuery({
    ...
    fn: internal.mcpToolsQueue.listQueue,
    args: listQueueArgs,
    identityArg: "caller",
  }),
  defineMcpMutation({
    ...
    fn: internal.mcpToolsQueue.claimQueue,
    args: claimQueueArgs,
    identityArg: "caller",
  }),
  defineMcpMutation({
    ...
    fn: internal.mcpToolsQueue.submitQueueResult,
  ...
  defineMcpMutation({
    ...
    fn: internal.mcpToolsWrite.setupMove,
    args: setupMoveArgs,
    identityArg: "caller",
  }),
  defineMcpMutation({
    ...
    fn: internal.mcpToolsWrite.packBoxes,
    args: packBoxesArgs,
    identityArg: "caller",
  }),
  defineMcpMutation({
    ...
    fn: internal.mcpToolsSetup.updateMove,
    args: updateMoveArgs,
    identityArg: "caller",
  }),
  defineMcpMutation({
    ...
    fn: internal.mcpToolsSetup.addMoveParticipant,
  ...
  defineMcpQuery({
    ...
    fn: internal.mcpToolsSetup.listTransport,
  ...
  defineMcpMutation({
    ...
    fn: internal.mcpToolsSetup.upsertTransport,
  ...
  defineMcpMutation({
    ...
    fn: internal.mcpToolsSetup.placeBox,
    args: placeBoxArgs,
    identityArg: "caller",
  }),
  defineMcpMutation({
    ...
    fn: internal.mcpToolsSetup.updateBox,
    args: updateBoxArgs,
    identityArg: "caller",
  }),
  defineMcpMutation({
    ...
    fn: internal.mcpToolsSetup.updateItem,
    args: updateItemArgs,
    identityArg: "caller",
  }),
  defineMcpMutation({
    ...
    fn: internal.mcpToolsSetup.convertItemToBox,
  ...
  defineMcpMutation({
    ...
    fn: internal.mcpToolsSetup.archiveItem,
  ...
  defineMcpAction({
    ...
    fn: internal.mcpToolsImages.getImages,
    args: getImagesArgs,
    identityArg: "caller",
  }),
  defineMcpAction({
    ...
    fn: internal.mcpToolsImages.addImages,
    args: addImagesArgs,
    identityArg: "caller",
  }),
  defineMcpMutation({
    ...
    fn: internal.mcpToolsImages.attachPhotos,
